class Game {
  ...
  loadEnvironment(loader) {
    const game = this;
    loader.load(`${this.assetsPath}glb/wowcity.glb`, function (data) {
...
class Player {
  constructor(game, options) {
    ...
    //   player.object.scale.set(1, 1, 1);
      ...
      player.object.position.set(2000, 0, 500);
...
class PlayerLocal extends Player {
  constructor(game, model) {
    ...
    //       "Authorization",
    //       "Basic " + btoa("sachinpradhan:ba8a1788-22e1-11ed-bcc7-0242ac150003")
    //     );
